...
public class sorted extends JFrame implements ActionListener {

    Sorting sorta = new Sorting();
    private JTextArea outputTextArea;

    public sorted() {
        initializeFrame("Sorted");
    }
    ...
    public void sortedArrayOutput(int s) {
        int[] sorted = Sorting.sortedArray(s);

        displayArray("the sorted array:", sorted);
