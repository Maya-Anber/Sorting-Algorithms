...
public class inverse extends JFrame implements ActionListener {
    ...
    public void inverseArrayOutput(int s) {
        int[] inverse = Sorting.inverseSortedArray(s);

        displayArray("the inverse array:", inverse);

        Sorting.countComparisons = 0;
        Sorting.countInterchanges = 0;

        long startBubble = System.currentTimeMillis();
        int[] bubble = inverse.clone();
       ...
       displayArray("the output array:", Sorting.countingSort(count));
